...
?>
              ...
              <!--Botones para importar la tabla-->
              <div class="col-lg-2 text-center mt-5" style="display: flex; justify-content: center; position: relative; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                        
              <a href="reportespro.php" type="button" class="btn btn-primary btn-xl pull-right w-100">
              ...
              <a href="reportexlspro.php" type="button" class="btn btn-success btn-xl pull-right w-100">
